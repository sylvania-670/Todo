<template>
  <section class="todoapp">
    ...
    <footer class="footer" v-show="hasTodos">
      ...
      <button class="clear-completed" v-show="completed" @click.prevent="deleteCompleted">delete finished Task</button>
    </footer>
  </section>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      deleteTodo (todo) {
        this.$emit('input', this.todos.filter(i => i !== todo))
      },
      deleteCompleted () {
        this.$emit('input', this.todos.filter(todo => !todo.completed))
      },
      editTodo (todo) {
        this.editing = todo
